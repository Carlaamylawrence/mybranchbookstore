  ...
  <div class="topbar">
    <div class="about-container m-5">
      ...
      <!-- Button trigger modal -->
        <button type="button"  class="editmodal mt-4 btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal">
              ...
              <div class="modal-body">
                <form @submit.prevent="updateUserInfo">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingLocation" v-model="location" >
                    <label for="floatingInput">Location</label>
                  </div>
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingABout" v-model="about" >
                    <label for="floatingPassword">Describe Yourself</label>
                  </div>
                <button type="submit" class="update mt-4 btn btn-outline-secondary" >Save</button>
                </form>
              </div>
